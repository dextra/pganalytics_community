...
class RegularExpressionException : public std::runtime_error
{
private:
	std::string _message;
public:
	explicit RegularExpressionException(const std::string &_message)
		: std::runtime_error("RegularExpression"), _message(_message)
	{}
	virtual ~RegularExpressionException() throw() {}
